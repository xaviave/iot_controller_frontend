...
class CategoryProvider with ChangeNotifier {
  ...
  late CategoryCommunication category_grpc_client;

  CategoryProvider() {
    category_grpc_client = CategoryCommunication();
    category_grpc_client.init();
    getCategoryItems();
  }

  Future<void> getCategoryItems() async {
    var response = await category_grpc_client.List();
    _categories = {
