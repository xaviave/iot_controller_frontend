...
class CoffeeMachinePartialUpdateRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<CategoryRequest>(
        11, _omitFieldNames ? '' : 'categories', $pb.PbFieldType.PM,
...
class CoffeeMachineRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.int>(
        6, _omitFieldNames ? '' : 'usedWaterLevel', $pb.PbFieldType.O3)
...
class CoffeeMachineResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.int>(9, _omitFieldNames ? '' : 'modeValue', $pb.PbFieldType.O3)
    ..a<$core.int>(
        10, _omitFieldNames ? '' : 'polymorphicCtype', $pb.PbFieldType.O3)
    ..pc<CategoryResponse>(
        11, _omitFieldNames ? '' : 'categories', $pb.PbFieldType.PM,
        subBuilder: CategoryResponse.create)
    ..a<$core.int>(12, _omitFieldNames ? '' : 'id', $pb.PbFieldType.O3)
